...
target("analysis_log")
    ...
    set_objectdir("obj")
    set_languages("c++11")
    add_files("testcases/analysis_log.cc")
...
target("test_log")
    ...
    set_objectdir("obj")
    set_languages("c++11")
    add_files("testcases/test_log.cc", "zest/common/*.cc")
    add_includedirs("/usr/include", "/usr/local/include", "/usr/include/tinyxml", ".")
    add_links("lib/libtinyxml.a")
...
target("test_eventloop")
    ...
    set_objectdir("obj")
    set_languages("c++11")
    add_files("testcases/test_eventloop.cc", "zest/common/*.cc", "zest/net/*.cc")
    add_includedirs("/usr/include", "/usr/local/include", "/usr/include/tinyxml", ".")
    add_links("lib/libtinyxml.a")
    add_syslinks("pthread")
    set_optimize("fastest")
...
target("test_timer")
    ...
    set_objectdir("obj")
    set_languages("c++11")
    add_files("testcases/test_timer.cc", "zest/common/*.cc", "zest/net/*.cc")
    add_includedirs("/usr/include", "/usr/local/include", "/usr/include/tinyxml", ".")
    add_links("lib/libtinyxml.a")
    add_syslinks("pthread")
    set_optimize("fastest")
